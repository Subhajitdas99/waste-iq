...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_pickup_requests_user_id"), "pickup_requests", ["user_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_collector_assignments_id"), "collector_assignments", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_collector_assignments_collector_id"),
        "collector_assignments",
        ["collector_id"],
        unique=False,
    )
