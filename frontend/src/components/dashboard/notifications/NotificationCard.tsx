...
const NOTIFICATION_TYPE_STYLES: Record<NotificationType, TypeStyle> = {
  ...
  weight_recorded: { icon: Scale, iconClassName: "bg-indigo-100 text-indigo-700" },
  weight_confirmed: { icon: CheckCircle, iconClassName: "bg-emerald-100 text-emerald-700" },
  weight_disputed: { icon: Scale, iconClassName: "bg-amber-100 text-amber-700" },
  dispute_resolved: { icon: CheckCircle, iconClassName: "bg-emerald-100 text-emerald-700" },
